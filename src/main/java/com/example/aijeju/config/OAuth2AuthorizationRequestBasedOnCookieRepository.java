...
public class OAuth2AuthorizationRequestBasedOnCookieRepository implements
    ...
    public final static String OAUTH2_AUTHORIZATION_COOKIE_NAME = "oauth2_auth_request";
    ...
    public OAuth2AuthorizationRequest loadAuthorizationRequest(HttpServletRequest request){
        Cookie cookie = WebUtils.getCookie(request, OAUTH2_AUTHORIZATION_COOKIE_NAME);
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request,
        ...
        CookieUtil.addCookie(response,OAUTH2_AUTHORIZATION_COOKIE_NAME, CookieUtil.serialize(
